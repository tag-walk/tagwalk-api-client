...
class ShowroomApiAuthenticator extends AbstractGuardAuthenticator
{
    /**
     * @var ApiProvider
     */
    ...
    public function getUser($credentials, UserProviderInterface $userProvider)
    {
        ...
        if (isset($password, $email)) {
            try {
                $response = $this->provider->request('POST', '/api/showroom/users/login', [
                    RequestOptions::JSON => [
                        'email'    => $email,
                        'password' => $password,
                    ],
                ...
                return $this->serializer->deserialize($json, ShowroomUser::class, 'json');
